...
import type { ConversationStore, ConversationMetadata } from './types.js';
...
export class FileConversationStore implements ConversationStore {
    constructor(private readonly baseDir: string = '.agent-tea/conversations') {}
    ...
    async list(): Promise<{ sessionId: string; metadata: ConversationMetadata }[]> {
        try {
